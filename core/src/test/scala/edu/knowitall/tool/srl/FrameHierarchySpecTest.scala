...
object FrameHierarchySpecTest extends Specification {
  {
    ...
    "no nested frames are found in: '" + sentence + "'" in {
      val dgraph = DependencyGraph.stringFormat.read("nsubj(ran_VBD_1_5, John_NNP_0_0); prep(ran_VBD_1_5, down_IN_2_9); punct(ran_VBD_1_5, ._._5_22); pobj(down_IN_2_9, hill_NN_4_18); det(hill_NN_4_18, the_DT_3_14)")
...

  {
    ...
    ("one nested frame is found in: '" + sentence + "'") in {
      val dgraph = DependencyGraph.stringFormat.read("nsubj(wants_VBZ_1_5, John_NNP_0_0); xcomp(wants_VBZ_1_5, run_VB_3_14); punct(wants_VBZ_1_5, ._._7_31); aux(run_VB_3_14, to_TO_2_11); prep(run_VB_3_14, down_IN_4_18); pobj(down_IN_4_18, hill_NN_6_27); det(hill_NN_6_27, the_DT_5_23)")
...

  {
    ...
    ("no errors with: '" + sentence + "'") in {
      val dgraph = DependencyGraph.stringFormat.read("nsubj(wants_VBZ_1_6, John_NNP_0_0); xcomp(wants_VBZ_1_6, blow_VB_3_15); punct(wants_VBZ_1_6, ._._9_41); aux(blow_VB_3_15, to_TO_2_12); dobj(blow_VB_3_15, nose_NN_5_24); cc(blow_VB_3_15, and_CC_6_29); conj(blow_VB_3_15, eat_VB_7_33); poss(nose_NN_5_24, his_PRP$_4_20); dobj(eat_VB_7_33, corn_NN_8_37)")
      val frames = IndexedSeq(
...

  {
    ...
    ("no errors with: '" + sentence + "'") in {
      val dgraph = DependencyGraph.stringFormat.read("nsubj(said_VBD_1_5, John_NNP_0_0); ccomp(said_VBD_1_5, works_VBZ_3_15); punct(said_VBD_1_5, ._._6_30); nsubj(works_VBZ_3_15, Fred_NNP_2_10); prep(works_VBZ_3_15, on_IN_4_21); pobj(on_IN_4_21, Sunday_NNP_5_24)")
      val frames = IndexedSeq(
...

  {
    ...
    ("no errors with: '" + sentence + "'") in {
      val dgraph = DependencyGraph.stringFormat.read("nsubj(said_VBD_1_5, Mary_NNP_0_0); ccomp(said_VBD_1_5, wants_VBZ_3_15); punct(said_VBD_1_5, ._._9_42); nsubj(wants_VBZ_3_15, John_NNP_2_10); xcomp(wants_VBZ_3_15, sleep_VB_5_24); aux(sleep_VB_5_24, to_TO_4_21); prep(sleep_VB_5_24, under_IN_6_30); pobj(under_IN_6_30, tree_NN_8_38); det(tree_NN_8_38, a_DT_7_36)")
      val frames = IndexedSeq(
